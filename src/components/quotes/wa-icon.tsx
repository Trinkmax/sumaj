/**
 * Ícono de WhatsApp (lucide no lo trae). Compartido por share-dialog,
 * quote-dialog y la página pública /p/[token] — una sola copia del path.
 * Sin "use client": sirve igual en server y client components.
 */
